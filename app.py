...
<div style='text-align: center; background: linear-gradient(135deg, #004e92 0%, #000428 100%); padding: 20px; border-radius: 10px; color: white; margin-bottom: 20px;'>
    ...
    <p style='margin-top:10px;'>Tác giả: Thầy Mai Đức Tuyển - PTDTBT TH Sủng Thài</p>
</div>
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Mai Đức Tuyển - Trường PTDTBT Tiểu học Sủng Thài - ĐT: 033 3204 402</div>", unsafe_allow_html=True)
